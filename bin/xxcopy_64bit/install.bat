...
if not exist .\xxpbar64.exe  goto error1
...
echo        XXPBAR64.EXE    // used when /PB (progress bar) is used
...
echo.
echo  Congratulations!!!  XXCOPY64 has been successfully installed.
echo.
echo  If you ever need to uninstall the XXCOPY64 software package,
